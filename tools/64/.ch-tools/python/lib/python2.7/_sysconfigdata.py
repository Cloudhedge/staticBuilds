...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BASEMODLIBS': '',
 'BEOS_THREADS': 0,
 'BINDIR': '/opt/python64/bin',
 'BINLIBDEST': '/opt/python64/lib/python2.7',
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-aliasing -O3 -DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes',
 'CFLAGSFORSHARED': '-fPIC',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in Makefile.pre.in',
 'CONFIG_ARGS': "'--prefix=/opt/python64/' '--enable-unicode=ucs4' '--enable-shared' 'CFLAGS=-O3'",
 'CONFINCLUDEDIR': '/opt/python64/include',
 'CONFINCLUDEPY': '/opt/python64/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'CPPFLAGS': '-I. -IInclude -I./Include',
 'CXX': 'g++ -pthread',
 'C_THREADS': 0,
 'DESTDIRS': '/opt/python64 /opt/python64/lib /opt/python64/lib/python2.7 /opt/python64/lib/python2.7/lib-dynload',
 'DESTLIB': '/opt/python64/lib/python2.7',
 'DESTPATH': '',
 'DESTSHARED': '/opt/python64/lib/python2.7/lib-dynload',
 'DIRMODE': 755,
 ...
 'HURD_C_THREADS': 0,
 'INCLDIRSTOMAKE': '/opt/python64/include /opt/python64/include /opt/python64/include/python2.7 /opt/python64/include/python2.7',
 'INCLUDEDIR': '/opt/python64/include',
 'INCLUDEPY': '/opt/python64/include/python2.7',
 ...
 'LIBC': '',
 'LIBDEST': '/opt/python64/lib/python2.7',
 'LIBDIR': '/opt/python64/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBP': '/opt/python64/lib/python2.7',
 'LIBPC': '/opt/python64/lib/pkgconfig',
 'LIBPL': '/opt/python64/lib/python2.7/config',
 ...
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/python64/lib/python2.7',
 'MACH_C_THREADS': 0,
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-fno-strict-aliasing -O3 -DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes -I. -IInclude -I./Include -fPIC -DPy_BUILD_CORE',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/opt/Python-2.7.6:',
 'SCRIPTDIR': '/opt/python64/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/opt/Python-2.7.6: ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/opt/Python-2.7.6',
 'abs_srcdir': '/opt/Python-2.7.6',
 'build': 'x86_64-unknown-linux-gnu',
 'datarootdir': '/opt/python64/share',
 'exec_prefix': '/opt/python64',
